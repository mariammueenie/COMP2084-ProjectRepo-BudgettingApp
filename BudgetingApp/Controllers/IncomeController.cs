...
namespace BudgetingApp.Controllers
{
    public class IncomeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IncomeId,Source,Amount,Date")] Income income)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IncomeId,Source,Amount,Date")] Income income)
        {
