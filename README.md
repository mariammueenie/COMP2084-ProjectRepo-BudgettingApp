App Link: https://mmueen-budgeting-app.azurewebsites.net/

The Budget Sorting Application, or Budgeting App for short, is an application designed to take input from an user regarding the Budget they take, and using a database help the user Budget their expense so they don't overspend or fall into debt.
